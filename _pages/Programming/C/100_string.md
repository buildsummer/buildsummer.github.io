...
---
###3.1 Null-terminated String 널종료문자열
* 배열의 끝임을 알려주는 문자 0. <font color = 'ff8000'>**'0' 이 아니다**</font>  아스키 코드가 0이며 '\0'임
  ...
  * <font color = 'ff8000'>**%s**</font> 는 Nullstring이 나올때까지 읽으라는 얘기임
